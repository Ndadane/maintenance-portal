        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitLabel = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TenantAssignments_Units_UnitId",
                        column: x => x.UnitId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantAssignmentId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceRequests_TenantAssignments_TenantAssignmentId",
                        column: x => x.TenantAssignmentId,
                        principalTable: "TenantAssignments",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestPhotos_MaintenanceRequests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "MaintenanceRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRequests_TenantAssignmentId",
                table: "MaintenanceRequests",
                column: "TenantAssignmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestPhotos_RequestId",
                table: "RequestPhotos",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_TenantAssignments_TenantId",
                table: "TenantAssignments",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_TenantAssignments_UnitId",
                table: "TenantAssignments",
                column: "UnitId");
